...
public class NetworkController : MonoBehaviourPunCallbacks {
    ...
    [SerializeField] private Text playerRoomMax;
    ...
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        ...
        RoomOptions roomOptions = new RoomOptions()
        {
            IsOpen = true,
            IsVisible = true,
            MaxPlayers = byte.Parse(playerRoomMax.text)
        };
    ...
    private void CountdownPlayStart()
    {
        if (PhotonNetwork.CurrentRoom.PlayerCount == byte.Parse(playerRoomMax.text))
        {
